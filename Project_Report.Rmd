...
```{r }
out_id <- searchplos(q='statistical', fl="id", fq='doc_type:full', limit=100)
out_fulltext <- plos_fulltext(doi=out_id$data$id[10])
xpathSApply(xmlParse(out_fulltext$`10.1371/journal.pcbi.1001057`), "//abstract", xmlValue)
